...
namespace UnityMCP.Editor.Tools
{
    ...
    public static class FindGameObjects
    {
        ...
        /// </summary>
        [MCPTool("gameobject_find", "Finds GameObjects by name, tag, layer, component, path, or instance ID. Returns instance IDs needed by gameobject_manage and component_manage. Use scene_get_hierarchy for a structural overview instead.", Category = "GameObject", ReadOnlyHint = true)]
